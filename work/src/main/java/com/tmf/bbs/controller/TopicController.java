...
public class TopicController {
	...
	@ResponseBody
	public String add(HttpServletRequest request, HttpServletResponse response,String title,String content,Integer topics_user_id){
       services.addTopic(request,response,title,content,topics_user_id);
